...
var MyGame = ig.Game.extend({
	...
	init: function () {
		...
		this.showHUD = false;
		//ig.music2.add('media/snd/music/march.wav', 'march');
		//ig.music2.add('media/snd/music/battle-slow.wav', 'battle-slow');
		//ig.music2.add('media/snd/music/battle-fast.wav', 'battle-fast');
		//ig.music2.add('media/snd/music/battle-trans-s2f.wav', 'battle-sf');
		//ig.music2.add('media/snd/music/battle-trans-f2s.wav', 'battle-fs');
