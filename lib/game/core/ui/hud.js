...
var UI = ig.Class.extend({
	...
	_initButtons: function () {
		...
		this.buttons.push(ig.game.spawnEntity(Tower.DeleteButton, 2, 97));
		this.buttons.push(ig.game.spawnEntity(Tower.RepairButton, 10, 97));		
	...
	draw: function () {
		...
		this.buttons.forEach(function (btn) {
			...
			if (btn instanceof Tower.RepairButton) {
				btn.draw();
			}
		}.bind(this));
