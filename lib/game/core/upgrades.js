...
FriendlyUnit.inject({
	upgrades: [],
	_appliedUpgrades: {},
	_upgradeSound: new ig.Sound('media/snd/sfx/powerup.*'),
	...
	maxUpgrade: function (type) {
		var applicable = this.upgrades.filter(function (upgrade) {
			return upgrade instanceof type;
		}).sort(Tower.Upgrade.compare);
